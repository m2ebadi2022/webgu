        ...
        <div class="form-group col-sm-12 ">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="input2" name="type" required>     
                </div>
                <div class="col">
                    <label for="input3" class="form-label">تعداد</label>
                    <input type="text" class="form-control" id="input3" name="count" required>
                </div>
                <div class="col">
                    <label for="input4" class="form-label">ساعت ورود/خروج</label>
                    <input type="time" class="form-control" id="input4" name="time">
                </div>
                <div class="col">
                    <label for="input5" class="form-label">شرح</label>
                    <input type="text" class="form-control" id="input5" name="sharh">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-2">
                    <label for="input6" class="form-label">کد نگهبان</label>
                    <input type="number" class="form-control" id="input6" name="code_negahban">
                </div>
                <div class="col-sm-10">
                    <label for="input6" class="form-label">توضیحات</label>
                    <input type="text" class="form-control" id="input6" name="tozihat">
                </div>   
            </div>
        </div>
...
<?php if ($privlege[0]['amval_read']==1): ?>
    <div class="d-none d-print-block" align="center"><h3 >سیستم ورود و خروج نگهبانی</h3><br> گزارش ورود و خروج اموال مورخ :<?=$date_shamsi ?></div>
<br>
...
<div class="d-print-none">
    <ul class="pagination">
        ...
        <li class="page-item <?php if($page_c==50){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/4?p=50">50</a>
        </li>
        <li class="page-item <?php if($page_c==200){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/4?p=200">200</a>
        </li>
        <li class="page-item <?php if($page_c==500){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/4?p=500">500</a>
        </li>
        <li class="page-item <?php if($page_c==1000){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/4?p=1000">1000</a>
        </li>
        <li class="page-item <?php if($page_c==$count_all){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/4?p=<?=$count_all ?>">همه (<?=$count_all ?>)</a>
        </li>
...
<div class="table-responsive">
    ...
    <thead>
        <tr>
            ...
            <th scope="col">نوع اموال</th>
            <th scope="col">تعداد</th>
            <th scope="col">ساعت ورود/خروج</th>
            <th scope="col">شرح</th>
            <th scope="col">کد نگهبان</th>
            <th class="d-print-none" scope="col">توضیحات</th>
