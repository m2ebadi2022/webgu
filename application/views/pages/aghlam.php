...
<div style="width: 95%;" class="container-fluid">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            ...
                            <input type="texr" class="form-control" id="input6" name="sharh">
    ...
    <?php endif;  ?>
        ...
        <div class="d-none d-print-block" align="center"><h3 >سیستم ورود و خروج نگهبانی</h3><br> گزارش ورود و خروج اقلام مصرفی مورخ :<?=$date_shamsi ?></div>
        ...
        <div class="d-print-none">
            <ul class="pagination">
                ...
                <li class="page-item <?php if($page_c==50){echo 'active';} ?>">
                    <a class="page-link" href="http://<?php echo base_url(); ?>home/page/7?p=50">50</a>
                </li>
                <li class="page-item <?php if($page_c==200){echo 'active';} ?>">
                    <a class="page-link" href="http://<?php echo base_url(); ?>home/page/7?p=200">200</a>
                </li>
                <li class="page-item <?php if($page_c==500){echo 'active';} ?>">
                    <a class="page-link" href="http://<?php echo base_url(); ?>home/page/7?p=500">500</a>
                </li>
                <li class="page-item <?php if($page_c==1000){echo 'active';} ?>">
                    <a class="page-link" href="http://<?php echo base_url(); ?>home/page/7?p=1000">1000</a>
                </li>
                <li class="page-item <?php if($page_c==$count_all){echo 'active';} ?>">
                    <a class="page-link" href="http://<?php echo base_url(); ?>home/page/7?p=<?=$count_all ?>">همه (<?=$count_all ?>)</a>
                </li>
