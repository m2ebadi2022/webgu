    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <input type="number" step="0.01" class="form-control" id="input7" name="vazn">
            </div>

            <div class="col">
                <label for="input11" class="form-label">واحد</label>
                <input type="text" class="form-control" id="input11" name="vahed">
            </div>
            <div class="col">
                <label for="input8" class="form-label">فرستنده</label>
                <input type="text" class="form-control" id="input8" name="sender">
            </div>
            <div class="col">
                <label for="input9" class="form-label">گیرنده</label>
                <input type="text" class="form-control" id="input9" name="reciver">
            </div>
            <div class="col">
                <label for="input10" class="form-label">کد نگهبان</label>
                <input type="number" class="form-control" id="input10" name="code_negahban">
            </div>
        </div>
        <div class="row">   
            <div class="col">
...
<?php if ($privlege[0]['khodro_pey_read']==1): ?>
    <div class="d-none d-print-block" align="center"><h3 >سیستم ورود و خروج نگهبانی</h3><br> گزارش بارگیری و تخلیه(خودرو) مورخ :<?=$date_shamsi ?></div>
<br>
...
<div class="d-print-none">
    <ul class="pagination">
        ...
        <li class="page-item <?php if($page_c==50){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/9?p=50">50</a>
        </li>
        <li class="page-item <?php if($page_c==200){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/9?p=200">200</a>
        </li>
        <li class="page-item <?php if($page_c==500){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/9?p=500">500</a>
        </li>
        <li class="page-item <?php if($page_c==1000){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/9?p=1000">1000</a>
        </li>
        <li class="page-item <?php if($page_c==$count_all){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/9?p=<?=$count_all ?>">همه (<?=$count_all ?>)</a>
        </li>
...
<div class="table-responsive">
    ...
    <thead>
        <tr>
            ...
            <th scope="col">شرح</th>
            <th scope="col"> وزن باسکول/تعداد</th>
