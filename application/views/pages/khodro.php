...
<div class="d-print-none">
    <ul class="pagination">
        ...
        <li class="page-item <?php if($page_c==50){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/3?p=50">50</a>
        </li>
        <li class="page-item <?php if($page_c==200){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/3?p=200">200</a>
        </li>
        <li class="page-item <?php if($page_c==500){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/3?p=500">500</a>
        </li>
        <li class="page-item <?php if($page_c==1000){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/3?p=1000">1000</a>
        </li>
        <li class="page-item <?php if($page_c==$count_all){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/3?p=<?=$count_all ?>">همه (<?=$count_all ?>)</a>
        </li>
