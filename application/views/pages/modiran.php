    ...
    <fieldset>
        ...
        <div class="form-group col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col">
                    <label for="input3" class="form-label">ساعت ورود</label>
                    <input type="time" class="form-control" id="input3" name="vorod">
                </div>
                <div class="col">
                    <label for="input4" class="form-label">ساعت خروج</label>
                    <input type="time" class="form-control" id="input4" name="khoroj">
                </div>
                <div class="col">
                    <label for="input5" class="form-label">کد نگهبان</label>
                    <input type="number" class="form-control" id="input5" name="code_negahban">
                </div>
            </div>
...
<?php if ($privlege[0]['modiran_read']==1): ?>
    <div class="d-none d-print-block" align="center"><h3 >سیستم ورود و خروج نگهبانی</h3><br> گزارش ورود و خروج مدیران ارشد مورخ :<?=$date_shamsi ?></div>
    <br>
    ...
    <ul class="pagination">
        ...
        <li class="page-item <?php if($page_c==50){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/2?p=50">50</a>
        </li>
        <li class="page-item <?php if($page_c==200){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/2?p=200">200</a>
        </li>
        <li class="page-item <?php if($page_c==500){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/2?p=500">500</a>
        </li>
        <li class="page-item <?php if($page_c==1000){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/2?p=1000">1000</a>
        </li>
        <li class="page-item <?php if($page_c==$count_all){echo 'active';} ?>">
            <a class="page-link" href="http://<?php echo base_url(); ?>home/page/2?p=<?=$count_all ?>">همه (<?=$count_all ?>)</a>
        </li>
